                                                      ...
                                                      Padding(
                                                        padding:
                                                            const EdgeInsets
                                                                ...
                                                                bottom: 3),
                                                        child: Text(
                                                          '${(widget.limit * widget.animation!.value).toInt()}',
                                                          textAlign:
                                                              TextAlign.center,
                                                          style: TextStyle(
                                                            fontFamily:
                                        ...
                                        Padding(
                                          ...
                                          child: Container(
                                            ...
                                            child: Column(
                                              ...
                                              children: <Widget>[
                                                Text(
                                                  '${widget.limit - (widget.TotaleConsomation * widget.animation!.value).toInt()}',
